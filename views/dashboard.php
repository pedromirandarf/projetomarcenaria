...
<body class="">
  ...
  <div class="col-lg-3 col-md-6 col-sm-6">
    <div class="card card-stats">
      <div class="card-header card-header-primary card-header-icon">
        ...
        <h3 class="card-title"> 230k
        </h3>
      </div>
      <div class="card-footer">
        <div class="stats">
          <i class="material-icons text-primary">warning</i>
          <a href="">Total de Pagamentos Hoje</a>
        </div>
      </div>
    </div>
  </div>
  <div class="col-lg-3 col-md-6 col-sm-6">
    <div class="card card-stats">
      <div class="card-header card-header-primary card-header-icon">
        ...
        <p class="card-category">Nº de Clientes</p>
        <h3 class="card-title">15</h3>
      </div>
      <div class="card-footer">
        <div class="stats">
          <i class="material-icons">date_range</i> Clientes no Sistema
        </div>
      </div>
    </div>
  </div>
  <div class="col-lg-3 col-md-6 col-sm-6">
    <div class="card card-stats">
      <div class="card-header card-header-primary card-header-icon">
        ...
        <p class="card-category">Vendas Feitas</p>
        <h3 class="card-title">75</h3>
      </div>
      <div class="card-footer">
        <div class="stats">
          <i class="material-icons">local_offer</i> Produtos no Sistema
        </div>
      </div>
    </div>
  </div>
  <div class="col-lg-3 col-md-6 col-sm-6">
    <div class="card card-stats">
      ...
      <div class="card-footer">
        <div class="stats">
          <i class="material-icons">update</i>Usuários Cadastrados
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="col-lg-6 col-md-12">
    <div class="card">
      <div class="card-header card-header-primary">
        ...
        <p class="card-category">As pessoas que fazem acontecer</p>
      </div>
  ...
  <div class="col-lg-6 col-md-12">
    <div class="card">
      <div class="card-header card-header-primary">
        ...
        <p class="card-category">Os que se destacam</p>
      </div>
      <div class="card-body table-responsive">
        <table class="table table-hover">
          <thead class="text-primary">
      ...
      <footer class="footer">
        <div class="container-fluid">
          ...
          <div class="copyright float-right">
            ...
            </script>, desnvolvido por Pedro Miranda e Tadeu Abreu.
          </div>
        </div>
      </footer>
    </div>
...
$login_cookie = $_COOKIE['login'];
  ...
  while($aux2!=($aux+1))
  {
    echo "<tr><td>".$aux2."<td>".$nome[$aux2]."</td><td>".$email[$aux2]."</td></tr>";
    $aux2++;
  }
  echo "</tbody>  </table>  </div></div></div>";

  /* FIM DA TABELA 1  E INICIO DA 2 */
  ...
  while($aux2!=($aux+1))
  {
    echo "<tr><td>".$aux2."<td>".$nome[$aux2]."</td><td>".$email[$aux2]."</td><td>".$telefone[$aux2]."</td></tr>";
    $aux2++;
  }
